...
export const BurgerConstructor = ({
  ...
  const otherIngredients = ingredients.slice(0, bunIndex).concat(ingredients.slice(bunIndex + 1));
  ...
  return <section className={styles.burger_constructor}>
    {
      burgerItems.map((burgerItem, index) => {
        ...
        return <BurgerStructureItem ingredient={burgerItem} isTopBun={isTopBun} isBottomBun={isBottomBun} />
      })
    }
  </section>;
};
